...
try:
    ...
    while True:
        ...
        full_text_keywords = [
            "all lyrics", "full text", "complete lyrics", "entire text", "all transcript text", "full lyrics",
            "total speech", "total voice", "total lyrics", "total transcript text", "total transcript", "all text","print lyrics"
            "full speech", "full song", "complete song", "entire song", "full voice", "entire lyrics", "entire voice","full transcript"
            "すべての歌詞", "全文", "完全な歌詞", "全体のテキスト", "すべてのトランスクリプトテキスト", "完全な歌詞",
